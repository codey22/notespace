...
import { Link, Cloud, Lock, Share2, Sun, Moon, Menu, X, Plus } from "lucide-react";
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 h-16 bg-bg/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 z-50 flex items-center justify-between px-4 md:px-8 transition-colors duration-300">
            ...
            <div className="hidden md:flex items-center space-x-2">
                <IconButton icon={Plus} tooltip="New note" onClick={() => console.log("New Note")} />
            ...
            <AnimatePresence>
                {isMobileMenuOpen && (
                    ...
                    >
                        <div className="flex items-center justify-between p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer" onClick={() => console.log("New Note")}>
